...
import { ExternalLink, User, Tag, Clock, Plus, ShieldCheck, ThumbsUp, Hash, Award, Hexagon, Calendar, MessageSquare, Edit2, Trash2, AlertTriangle, X, Globe } from 'lucide-react';
          ...
          <div className="flex items-center gap-3">
            ...
            {user ? (
              <div className="hidden sm:flex items-center gap-2 bg-slate-800 px-3 py-1.5 rounded-full border border-slate-700">
                ...
                <span className="text-xs font-mono text-slate-300">{t.user} {user.uid.slice(0, 5)}</span>
              </div>
            ) : (
