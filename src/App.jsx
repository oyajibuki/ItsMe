                  ...
                  <div className="flex items-center p-2 sm:p-3 gap-3">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-1 sm:gap-2">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        {isMine ? (
                          <>
                            <a href={tweetUrl} target="_blank" rel="noopener noreferrer" className="p-1.5 bg-black text-white rounded-md hover:opacity-80 transition-opacity" title={t.shareX}>
